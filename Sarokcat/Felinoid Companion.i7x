		...
		if Player consents:
			...
			if fightoutcome >= 10 and fightoutcome <= 19:
				...
				if Player consents:
					...
					infect "Felinoid";
					say "     (Klauz the felinoid is now a possible ally! You can make him your active ally by typing [bold type][link]ally Klauz[end link][roman type] or [bold type][link]ally felinoid[end link][roman type] and initiate sex with him while active by typing [bold type][link]fuck Klauz[end link][roman type]. You can see all the allies you have with the [bold type][link]allies[end link][roman type] command. Allies will lower the XP you gain from battle, but can gain levels themselves to be more useful in a scrap. Want to get rid of an ally? Use [bold type][link]ally dismiss[end link][roman type], or just [bold type][link]dismiss[end link][roman type])[line break]";
